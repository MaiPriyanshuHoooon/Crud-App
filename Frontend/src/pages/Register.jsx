  ...
  return (
    <div className='min-h-[80vh] flex justify-center items-center'>
      ...
      <div className='flex items-center justify-center mb-3 '>
        ...
        <div className="mb-1 ">
          <label htmlFor="name" className="form-label inline-block  text-white">Name</label>

          <Field name = "name" type="name" className="rounded-full form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="name" placeholder="Enter name" />
        ...
        <div className='mb-2'>
          <LoaderButton isLoading={isLoading} text='Register' />
        </div>
        <div className="mb-2">
          <p className='text-end'>
            Already have an account ? <Link to={'/login'}
            className='font-bold text-white  underline'>Login</Link>
            </p>
        </div>
      </Form>
    </Formik>
